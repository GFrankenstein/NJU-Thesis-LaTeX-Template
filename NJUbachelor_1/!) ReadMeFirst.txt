...
关于平台：
本模板使用 texlive 2012 制作，使用 CTeX 套件或者版本过旧的 texlive 套件可能引起错误，还需要进一步的测试。
XP 平台可能出现字体错误，可以自行更改字体定义的部分，
Windows XP 用户可以注释掉字体定义部分，把载入宏包的字体选项由 nofonts 改为 winfonts，
当然，从 Win 7 移植必要的字体也是很好的解决方案。
字体问题主要由于平台的不兼容造成，但修改起来略有麻烦，
已经尽可能满足大多数人（Win 7 用户）的需求，如果确实还有很多人反馈 bug，可以再考虑改进的方法。
